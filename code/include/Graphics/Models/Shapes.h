...
namespace Plutonium
{
	...
	public:
		...
		_Check_return_ static void MakePlane(_In_ Mesh *mesh);
		/* Populates the specified buffer with a box. */
		_Check_return_ static void MakeBox(_In_ Mesh *mesh);
		/* Populates the specified buffer with a sphere. */
		_Check_return_ static void MakeSphere(_In_ Mesh *mesh, _In_ size_t meridians, _In_ size_t parallels);
