...
namespace Pu
{
	...
	public:
		...
		/* Logs a specific type of error message to the output. */
		static void Specific(_In_ LogType type, _In_ const char *format, _In_opt_ ...);
	...
	private:
		...
		void CreateCrashReport(const string &msg);
