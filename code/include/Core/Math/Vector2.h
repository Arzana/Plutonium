...
#pragma warning(pop)
	...
	_Check_return_ inline bool nrlyneql(_In_ Vector2 v, _In_ Vector2 w, _In_opt_ float tolerance = EPSILON)
	{
		return nrlyneql(v.X, w.X, tolerance) || nrlyneql(v.Y, w.Y, tolerance);
	}
