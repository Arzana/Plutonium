...
namespace Pu
{
	...
	public:
		...
		*/
		...
		_Check_return_ string PeekString(void) const;
		/* Reads a variable amount of bytes from the buffer as a length first UTF-32 string. */
		_Check_return_ ustring PeekUString(void) const;
		/*
	...
	private:
		...
		bool CheckOverflow(size_t bytesNeeded, bool raise) const;
	};
